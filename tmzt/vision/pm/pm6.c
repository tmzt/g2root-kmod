...
int(*smsm_set_sleep_duration)(uint32_t delay) = (void *)0xc0042bf4;

int(*__cpu_early_init)(void) = (void *)0xc003deb8;

/* irq.c */
int(*msm_irq_enter_sleep1)(bool arm9_wake, int from_idle) = (void *)0xc0039970;
int(*msm_irq_enter_sleep2)(bool arm9_wake, int from_idle) = (void *)0xc003a028;

/* gpio */
void(*msm_gpio_enter_sleep)(int from_idle) = (void *)0x0c003ffa4;
